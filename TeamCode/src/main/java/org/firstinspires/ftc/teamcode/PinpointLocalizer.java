...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2454.6371928664003; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 858.9655165707594; // x position of the perpendicular encoder (in tick units)
    }
