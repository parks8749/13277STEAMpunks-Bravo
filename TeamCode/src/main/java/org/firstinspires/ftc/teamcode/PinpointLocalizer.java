...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2535.2467956728665; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1822.7667466198213; // x position of the perpendicular encoder (in tick units)
    }
